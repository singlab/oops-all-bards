...
public class ItemData : MonoBehaviour
{
    ...
    public static BaseItem biggerStick = new BaseItem("biggerstick", "Bigger Stick", "It's a bigger, scarier stick.", BaseItem.ItemTypes.INSTRUMENTS, 10, new string[] { "stick", "stick" });
