   ...
   static public Behavior behaviorFactory0(int __$behaviorID, Object[] __$args, Map __$boundVars, GoalStep __$parentGoal, String __$signature, BehavingEntity __$thisEntity, __BehaviorDesc __$behaviorDesc) {
      switch (__$behaviorID) {
         ...
         case 4: {
            ...
            final __StepDesc[] __$steps = {new __StepDesc(11, GameAgent.__$stepFactory0_rfield), new __StepDesc(12, GameAgent.__$stepFactory0_rfield), new __StepDesc(13, GameAgent.__$stepFactory0_rfield), new __StepDesc(14, GameAgent.__$stepFactory0_rfield), new __StepDesc(15, GameAgent.__$stepFactory0_rfield)};
         ...
         case 6: {
            ...
            final __StepDesc[] __$steps = {new __StepDesc(16, GameAgent.__$stepFactory0_rfield), new __StepDesc(17, GameAgent.__$stepFactory0_rfield)};
         ...
         case 8: {
            ...
            final __StepDesc[] __$steps = {new __StepDesc(21, GameAgent.__$stepFactory0_rfield)};
         ...
         case 9: {
            ...
            final __StepDesc[] __$steps = {new __StepDesc(22, GameAgent.__$stepFactory0_rfield), new __StepDesc(23, GameAgent.__$stepFactory0_rfield)};
         ...
         case 10: {
            ...
            final __StepDesc[] __$steps = {new __StepDesc(24, GameAgent.__$stepFactory0_rfield), new __StepDesc(25, GameAgent.__$stepFactory0_rfield)};
         ...
         case 12: {
            // lookForQuip-11->ConditionalStep28_IF_FailStep_1
               final Object[] __$behaviorFrame = __$args;
         ...
         case 11: {
            ...
            final __StepDesc[] __$steps = {new __StepDesc(26, GameAgent.__$stepFactory0_rfield), new __StepDesc(27, GameAgent.__$stepFactory0_rfield), new __StepDesc(28, GameAgent.__$stepFactory0_rfield), new __StepDesc(29, GameAgent.__$stepFactory0_rfield), new __StepDesc(30, GameAgent.__$stepFactory0_rfield)};
         ...
         case 13: {
            ...
            final __StepDesc[] __$steps = {new __StepDesc(31, GameAgent.__$stepFactory0_rfield), new __StepDesc(32, GameAgent.__$stepFactory0_rfield), new __StepDesc(33, GameAgent.__$stepFactory0_rfield)};
            return new CollectionBehaviorDebug(__$parentGoal, null, null, null, null, false, __$signature, (short)0, 13, null, __$steps, 3, __$behaviorDesc);
         }
         case 14: {
